<#
    ...
    scripts/windows/windows-vmtools.ps1.

    Installs VMware Tools from the Tools ISO (mounted at E:) and re-attempts
    if the services fail on the first attempt. Packer requires the VMware
    Tools service to be running (guest IP + communicator readiness).
#>
